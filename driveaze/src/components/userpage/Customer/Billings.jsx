...
const Billings = () => {
  ...
  const fetchJobs = async (page) => {
    try {
      ...
      const response = await UserService.getAllBillsWithPaginationAndStatusesByCustomerPhoneNo(customerPhoneNo, statuses, page, token);
              ...
              filteredBills.map((bill) => (
                ...
                >
                  ...
                  {/* <p className="text-gray-600 mt-2 font-bold">
                    Job ID: {bill.jobRegistry.jobId} 
                  </p> */}
                  <p className="text-gray-600 mt-2 font-bold">
                    Customer: {bill.ownerName} {/* Display customer name */}
                  </p>
                  <p className="text-gray-600 mt-2 font-bold">
                    StartedDate: {bill.billDate} 
                  </p>
