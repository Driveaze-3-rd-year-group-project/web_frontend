            ...
            <div className="flex flex-col items-center justify-center  shadow-sm border rounded-lg  p-4">
                <div className="max-w-screen-xl h-100 ">
                    ...
                    <div className="flex items-center justify-center m-5">
                        <button className="text-sm text-white duration-150 bg-indigo-600 rounded hover:bg-indigo-500 active:bg-indigo-700 font-bold py-2 px-2 rounded w-4/5 h-10">
                            Book
                        </button>
                    </div>
